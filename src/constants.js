...
export const SkillsInfo = [
  ...
  },
  {
    title: 'Backend',
    skills: [
      { name: 'Node JS', logo: nodejsLogo, percentage: 78 },
      { name: 'Express JS', logo: expressjsLogo, percentage: 75 },
      { name: 'MySQL', logo: mysqlLogo, percentage: 70 },
  ...
  },
  {
    title: 'Languages',
    skills: [
      { name: 'C', logo: cLogo, percentage: 60 },
      { name: 'C++', logo: cppLogo, percentage: 65 },
